...
class EditorPlus(Tk):
    ...
    def _create_menu_bar_(self):
        ...
        edit_menu.add_command(label='插入.png图片', command=self.insretimage)
    ...
    def show_messagebox(self, type):
        ...
        if type == "帮助":
            ...
            messagebox.showinfo("帮助", "这是一个帮助文件。本软件可以编辑各种文本文档，右击输入栏可以打开更多功能页面", icon='question')

        else:

            messagebox.showinfo("关于", "EditorPlus 9 公司：JL.inc 制作人：焦健峰")
